...
data = holo.FileReader('Mire_negative_position_73.holo').get_all_frames() #ici tu mets le nom du fichier que tu veux ouvrir
...
for z in np.linspace(0.01, 0.3, 10):
    OutputField = Hologram.hologram1FFT(I2, nx, ny, 5.5e-6, 5e-6, 658e-9, -z)
